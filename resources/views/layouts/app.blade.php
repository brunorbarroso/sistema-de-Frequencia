...
<head>
    ...
    <!-- Fonts -->
    <link rel="stylesheet" href="{{ asset('assets/theme/css/font-awesome.min.css')}}" integrity="sha384-XdYbMnZ/QjLh6iI4ogqCTaIjrFk87ip+ekIjefZch0Y+PvJ8CDYtEs1ipDmPorQ+" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ asset('assets/theme/css/fonts.css')}}">

    <!-- Styles -->
    <link rel="stylesheet" href="{{ asset('assets/theme/css/bootstrap.min.css')}}" integrity="sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7" crossorigin="anonymous">
